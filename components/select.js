        ...
        >
          <View style={{ flexDirection: "row", padding: 15, backgroundColor: "#e4e4e4" }}>
            <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", paddingRight: 10 }}>
              <View
                style={{
                  backgroundColor: this.props.selected == item.value ? "#5fc414" : "transparent",
                  width: 10,
                  height: 10,
                  borderRadius: 100,
                }}
  ...
  render() {
    return (
      <>
        ...
        >
          <View
            style={{
              ...
              borderRadius: 5,
              maxHeight: this.props.height == undefined ? 400 : this.props.height,
              width: "75%",
            }}
          >
            <FlatList
        ...
        <Touchable onPress={() => this.setState({ showed: true })}>{this.props.renderBtn(this.state.selectedTitle)}</Touchable>
      </>
    );
  }
}
